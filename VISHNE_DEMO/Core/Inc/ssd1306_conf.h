...
#define SSD1306_CS_Port         LCD_CE_GPIO_Port
#define SSD1306_CS_Pin          LCD_CE_Pin
#define SSD1306_DC_Port         LCD_DC_GPIO_Port
#define SSD1306_DC_Pin          LCD_DC_Pin
#define SSD1306_Reset_Port      LCD_RST_GPIO_Port
#define SSD1306_Reset_Pin       LCD_RST_Pin
