...
#define BUS_BSP_LED_GPIO_CLK_ENABLE() __HAL_RCC_GPIOE_CLK_ENABLE()
#define BUS_BSP_LED_GPIO_PORT GPIOE
#define BUS_BSP_LED_GPIO_CLK_DISABLE() __HAL_RCC_GPIOE_CLK_DISABLE()
...
#define BUS_BSP_BUTTON_GPIO_PIN GPIO_PIN_3
...
#define USER_BUTTON_EXTI_LINE              EXTI_LINE_3
